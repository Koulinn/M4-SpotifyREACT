...
function AlbumMiddleSection() {
    return (
        <section id="middleMenu">
                <div class="col12 d-flex align-items-center p-4">
                    <div id="greenPlayBTN" class="d-flex align-items-center justify-content-center mr-4">
                    ...
                    <div id="favoriteCurrentContent" class="mr-4">
